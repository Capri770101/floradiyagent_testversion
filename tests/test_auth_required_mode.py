...
def test_unauthorized_requests_rejected(strict_settings, client):
    for method, path, body in [('POST', '/chat', {'message': '你好', 'user_id': 'anonymous'}), ('GET', '/cart', None), ('GET', '/orders', None), ('GET', '/points', None), ('GET', '/coupons', None), ('GET', '/favorites', None), ('GET', '/addresses', None), ('GET', '/admin/plans', None), ('GET', '/merchant/stats', None), ('POST', '/reviews', {'order_id': 'O_x', 'rating': 5})]:
...
def test_identity_from_token_not_body(strict_settings, client):
    r = client.post('/auth/register', json={'username': 'strict_user', 'password': 'secret123', 'nickname': '鉴权'})
