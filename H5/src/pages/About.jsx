  ...
  return (
    <div className="flex h-full flex-col bg-bg">
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-5 pb-10">
        {/* 品牌卡：衬线 logo + 金句 */}
        <div
          className="animate-hero hero-flora rounded-[4px] px-6 py-8 text-center"
        ...
        >
          ...
          />
          <p className="eyebrow mt-3">花艺工坊</p>
          <h2 className="mt-2 font-serif-cn text-[26px] font-normal text-ink">跳舞兰</h2>
          <p className="mt-3 font-serif-cn text-[15px] font-normal text-ink/80">
            真正的奢侈，是把时间，
            <br />
            温柔地交还给一朵花。
          </p>
          <p className="quote-credit mt-4">— 跳舞兰 —</p>
        </div>

        <Reveal delay={120}>
          <div className="mt-8 rounded-[4px] border border-line bg-white p-5">
            <p className="text-[13px] font-medium text-ink">跳舞兰 是什么？</p>
            <p className="mt-2 text-[12px] leading-relaxed text-sub">
              跳舞兰 是一家轻奢 AI 花艺设计平台。告诉我们的智能花艺师你的心意，
