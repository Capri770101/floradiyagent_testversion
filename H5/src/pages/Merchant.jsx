    ...
    return (
      <div className="flex h-full flex-col bg-bg">
        ...
        <div className="flex-1 px-5 pt-10 text-center">
          <p className="rounded-card bg-white p-8 text-[13px] text-sub shadow-card">
            无商家权限
            <br />
    ...
    <div className="flex h-full flex-col bg-bg">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-6">
        ...
        <div className="mt-2 grid grid-cols-5 gap-2">
          {cards.map((c) => (
            <div key={c.label} className="rounded-card bg-white p-3 text-center shadow-card">
        ...
        {tab === 'orders' ? (
          <>
            ...
            {orders.length === 0 ? (
              ...
              orders.map((o) => (
                <div key={o.order_id} className="mt-3 rounded-card bg-white p-4 shadow-card">
          ...
          reviews.map((r) => (
            <div key={r.id} className="mt-3 rounded-card bg-white p-4 shadow-card">
              <div className="flex items-center justify-between">
