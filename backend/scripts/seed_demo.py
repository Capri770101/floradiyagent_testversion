...
# 项目根目录加入 path，确保能 import backend.config as config / storage
ROOT = Path(__file__).resolve().parent.parent.parent
sys.path.insert(0, str(ROOT))

from backend.security import register_user  # noqa: E402
from backend.storage import chats, commerce, notify  # noqa: E402
...
def seed() -> None:
    ...
    from backend.storage.diy import save_diy_plan  # noqa: E402
