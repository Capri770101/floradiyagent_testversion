...
def init_db() -> None:
    ...
    try:
        ...
        conn.executescript(KNOWLEDGE_INDEXES)
        conn.commit()
    except Exception as exc:
        logger.warning('知识库表创建失败: %s', exc)
