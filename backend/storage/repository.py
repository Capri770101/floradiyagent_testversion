...
class Repository(ABC):
    ...
    @abstractmethod
    def search_plans(self, keyword: str, requirement: Any | None=None, location: dict[str, float] | None=None, max_km: float=5.0) -> list[dict[str, Any]]:
    ...
    @abstractmethod
    def list_shops(self, plan: dict[str, Any] | None, location: dict[str, float] | None=None, requirement: Any | None=None) -> list[dict[str, Any]]:
...
class MockRepository(Repository):
    ...
    def __init__(self) -> None:
        self._plans: list[dict[str, Any]] = [{'plan_id': 'P001', 'name': '康乃馨感恩花束', 'price': 199.0, 'desc': '11 支粉色康乃馨 + 满天星，适合送给母亲表达感恩。', 'effect_image_url': '/generated/plan_P001.png', 'merchant_name': '花漾工坊', 'tags': ['母亲节', '康乃馨', '温馨']}, {'plan_id': 'P002', 'name': '玫瑰轻奢花盒', 'price': 299.0, 'desc': '19 朵红玫瑰礼盒装，高级感拉满，适合纪念日。', 'effect_image_url': '/generated/plan_P002.png', 'merchant_name': '花漾工坊', 'tags': ['玫瑰', '礼盒', '高端']}, {'plan_id': 'P003', 'name': '向日葵花束', 'price': 159.0, 'desc': '阳光向日葵 + 尤加利叶，元气满满。', 'effect_image_url': '/generated/plan_P003.png', 'merchant_name': '绿野花艺', 'tags': ['向日葵', '活力', '平价']}, {'plan_id': 'P017', 'name': '洋桔梗梦境花束', 'price': 189.0, 'desc': '粉紫洋桔梗配满天星，梦境般温柔，告白纪念日心意之选。', 'effect_image_url': '/generated/plan_P017.png', 'merchant_name': '兰庭花礼', 'tags': ['洋桔梗', '告白', '温柔']}, {'plan_id': 'P018', 'name': '茉莉清香水培瓶', 'price': 99.0, 'desc': '白色茉莉水培玻璃瓶，满室清香，办公桌与床头治愈小景。', 'effect_image_url': '/generated/plan_P018.png', 'merchant_name': '巷陌花集', 'tags': ['茉莉', '水培', '清新']}, {'plan_id': 'P019', 'name': '帝王花鎏金礼盒', 'price': 459.0, 'desc': '南非帝王花配鎏金礼盒，霸气华贵，商务馈赠与乔迁之喜。', 'effect_image_url': '/generated/plan_P019.png', 'merchant_name': '都市花房', 'tags': ['帝王花', '礼盒', '高端']}, {'plan_id': 'P020', 'name': '马蹄莲极简花束', 'price': 149.0, 'desc': '白色马蹄莲单支竖线包装，极简高级，新居入伙与画廊风家居。', 'effect_image_url': '/generated/plan_P020.png', 'merchant_name': '花漾工坊', 'tags': ['马蹄莲', '极简', '高级']}, {'plan_id': 'P021', 'name': '铃兰幸福花束', 'price': 129.0, 'desc': '白色铃兰配绿叶衬底，象征幸福归来，婚礼与新生祝福首选。', 'effect_image_url': '/generated/plan_P021.png', 'merchant_name': '拾野花铺', 'tags': ['铃兰', '婚礼', '祝福']}, {'plan_id': 'P022', 'name': '洋牡丹奶油花束', 'price': 259.0, 'desc': '奶油色洋牡丹层层叠叠，甜而不腻，闺蜜下午茶与生日之选。', 'effect_image_url': '/generated/plan_P022.png', 'merchant_name': '玫瑰花园', 'tags': ['洋牡丹', '奶油色', '生日']}, {'plan_id': 'P023', 'name': '山茶花中式插花', 'price': 299.0, 'desc': '红山茶配青瓷瓶，中式留白意境，书房茶室雅致之选。', 'effect_image_url': '/generated/plan_P023.png', 'merchant_name': '半夏花房', 'tags': ['山茶花', '中式', '雅致']}, {'plan_id': 'P024', 'name': '大丽花复古花束', 'price': 359.0, 'desc': '暗红大丽花配复古包装纸，浓郁油画质感，宴会婚礼皆宜。', 'effect_image_url': '/generated/plan_P024.png', 'merchant_name': '暮色花园', 'tags': ['大丽花', '复古', '油画']}, {'plan_id': 'P025', 'name': '多肉阳光组盆', 'price': 49.0, 'desc': '五款多肉组合陶盆，好养耐放，办公室与阳台的元气小景。', 'effect_image_url': '/generated/plan_P025.png', 'merchant_name': '绿野花艺', 'tags': ['多肉', '绿植', '平价']}, {'plan_id': 'P026', 'name': '风信子清新水培', 'price': 89.0, 'desc': '紫色风信子球根水培，花色清雅，初春气息扑面而来。', 'effect_image_url': '/generated/plan_P026.png', 'merchant_name': '南巷花事', 'tags': ['风信子', '水培', '春日']}]
        for p in self._plans:
            tasks._write_mock_placeholder(f"plan_{p['plan_id']}")
        self._shops: list[dict[str, Any]] = [{'shop_id': 'S001', 'name': '花漾工坊(盐田店)', 'distance_km': 1.2, 'price_range': '100-300', 'rating': 4.8, 'plan_ids': ['P001', 'P002'], 'lat': 22.56, 'lng': 114.242}, {'shop_id': 'S002', 'name': '绿野花艺', 'distance_km': 2.5, 'price_range': '80-250', 'rating': 4.6, 'plan_ids': ['P003'], 'lat': 22.572, 'lng': 114.23}, {'shop_id': 'S003', 'name': '都市花房', 'distance_km': 3.8, 'price_range': '150-400', 'rating': 4.9, 'plan_ids': ['P001', 'P002', 'P003'], 'lat': 22.548, 'lng': 114.255}]
    ...
    def search_plans(self, keyword: str, requirement: Any | None=None, location: dict[str, float] | None=None, max_km: float=5.0) -> list[dict[str, Any]]:
        ...
        if not kw:
            ...
            plans = [p for p in self._plans if kw in p['name'].lower() or kw in p['desc'].lower() or any(kw in t for t in p['tags'])]
        if location and location.get('lat') is not None and (location.get('lng') is not None):
            in_range_names = {s['name'] for s in self._shops if s.get('lat') is not None and _haversine(location['lat'], location['lng'], s['lat'], s['lng']) <= max_km}
            plans = [p for p in plans if p.get('merchant_name') in in_range_names]
        for p in plans:
            p.setdefault('shop_id', next((s['shop_id'] for s in self._shops if s['name'] == p.get('merchant_name')), None))
...
class RemoteRepository(Repository):
    ...
    def __init__(self) -> None:
        ...
        self.paths = {'plans': settings.remote_plans_path, 'plan_detail': settings.remote_plan_detail_path, 'shops': settings.remote_shops_path, 'shop_detail': settings.remote_shop_detail_path}
...
def build_repository() -> Repository:
    ...
    if _db._run_async(catalog.catalog_ready()):
